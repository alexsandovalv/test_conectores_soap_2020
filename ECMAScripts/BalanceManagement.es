	...
	function balanceTransfer_BalanceManagement(balanceTransfer_actionCommonInfo_appInfo_appId,balanceTransfer_actionCommonInfo_appInfo_reference,balanceTransfer_actionCommonInfo_appInfo_extension_anyAttributeParam,balanceTransfer_actionCommonInfo_appInfo_extension_any,balanceTransfer_actionCommonInfo_userCode,balanceTransfer_actionCommonInfo_opCost,balanceTransfer_actionCommonInfo_opCost_exponent,balanceTransfer_actionCommonInfo_currencyCode,balanceTransfer_actionCommonInfo_extension_anyAttributeParam,balanceTransfer_actionCommonInfo_extension_any,balanceTransfer_donorSubscriberId_choice,balanceTransfer_receiverSubscriberId_choice,balanceTransfer_payer,balanceTransfer_balanceTransferInfo_transferAmount,balanceTransfer_balanceTransferInfo_transferAmount_exponent,balanceTransfer_balanceTransferInfo_transferCost,balanceTransfer_balanceTransferInfo_transferCost_exponent,balanceTransfer_balanceTransferInfo_transferWalletId,balanceTransfer_balanceTransferInfo_extension_anyAttributeParam,balanceTransfer_balanceTransferInfo_extension_any,balanceTransfer_extension_anyAttributeParam,balanceTransfer_extension_any,http_authorization,headers,privateRequest){
	    	var lRequest = "";
			lRequest = BalanceManagement.AS_URL + '?' + "_service=" + BalanceManagement.service + Ptf_DIM + "_application=" + BalanceManagement.application + Ptf_DIM + "_operation=" + "balanceTransfer"
						 + Ptf_DIM + "_mode=" + "JSON"
						 + Ptf_DIM + "request=" +  request + Ptf_DIM + "balanceTransfer.actionCommonInfo.appInfo.appId=" + encodeURIComponent(balanceTransfer_actionCommonInfo_appInfo_appId) + Ptf_DIM + "balanceTransfer.actionCommonInfo.appInfo.reference=" + encodeURIComponent(balanceTransfer_actionCommonInfo_appInfo_reference) + Ptf_DIM + "balanceTransfer.donorSubscriberId.choice=" + encodeURIComponent(balanceTransfer_donorSubscriberId_choice) + Ptf_DIM + "balanceTransfer.receiverSubscriberId.choice=" + encodeURIComponent(balanceTransfer_receiverSubscriberId_choice) + Ptf_DIM + "balanceTransfer.payer=" + encodeURIComponent(balanceTransfer_payer) + Ptf_DIM + "balanceTransfer.balanceTransferInfo.transferAmount=" + encodeURIComponent(balanceTransfer_balanceTransferInfo_transferAmount) + buildHeaders_BalanceManagement(headers) + Ptf_DIM + "private=" + encodeURIComponent(privateRequest);
...
if(balanceTransfer_actionCommonInfo_userCode != null){
lRequest = lRequest + Ptf_DIM + "balanceTransfer.actionCommonInfo.userCode="+encodeURIComponent(balanceTransfer_actionCommonInfo_userCode);
}
...
lRequest = lRequest + Ptf_DIM + "http.authorization="+encodeURIComponent(base64Encode(http_authorization));
		...
		function decrementBalance_BalanceManagement(decrementBalance_actionCommonInfo_appInfo_appId,decrementBalance_actionCommonInfo_appInfo_reference,decrementBalance_actionCommonInfo_appInfo_extension_anyAttributeParam,decrementBalance_actionCommonInfo_appInfo_extension_any,decrementBalance_actionCommonInfo_userCode,decrementBalance_actionCommonInfo_opCost,decrementBalance_actionCommonInfo_opCost_exponent,decrementBalance_actionCommonInfo_currencyCode,decrementBalance_actionCommonInfo_extension_anyAttributeParam,decrementBalance_actionCommonInfo_extension_any,decrementBalance_subscriberId_choice,decrementBalance_adjustmentAmount,decrementBalance_adjustmentAmount_exponent,decrementBalance_walletId,decrementBalance_totalFlag,decrementBalance_negativeBalanceUsageFlag,decrementBalance_actionCauseCode,decrementBalance_extension_anyAttributeParam,decrementBalance_extension_any,http_authorization,headers,privateRequest){
	    	var lRequest = "";
			lRequest = BalanceManagement.AS_URL + '?' + "_service=" + BalanceManagement.service + Ptf_DIM + "_application=" + BalanceManagement.application + Ptf_DIM + "_operation=" + "decrementBalance"
						 + Ptf_DIM + "_mode=" + "JSON"
						 + Ptf_DIM + "request=" +  request + Ptf_DIM + "decrementBalance.actionCommonInfo.appInfo.appId=" + encodeURIComponent(decrementBalance_actionCommonInfo_appInfo_appId) + Ptf_DIM + "decrementBalance.actionCommonInfo.appInfo.reference=" + encodeURIComponent(decrementBalance_actionCommonInfo_appInfo_reference) + Ptf_DIM + "decrementBalance.subscriberId.choice=" + encodeURIComponent(decrementBalance_subscriberId_choice) + Ptf_DIM + "decrementBalance.totalFlag=" + encodeURIComponent(decrementBalance_totalFlag) + Ptf_DIM + "decrementBalance.negativeBalanceUsageFlag=" + encodeURIComponent(decrementBalance_negativeBalanceUsageFlag) + buildHeaders_BalanceManagement(headers) + Ptf_DIM + "private=" + encodeURIComponent(privateRequest);
...
if(decrementBalance_actionCommonInfo_userCode != null){
lRequest = lRequest + Ptf_DIM + "decrementBalance.actionCommonInfo.userCode="+encodeURIComponent(decrementBalance_actionCommonInfo_userCode);
}
...
if(decrementBalance_walletId != null){
lRequest = lRequest + Ptf_DIM + "decrementBalance.walletId="+encodeURIComponent(decrementBalance_walletId);
}
...
lRequest = lRequest + Ptf_DIM + "http.authorization="+encodeURIComponent(base64Encode(http_authorization));
		...
		function incrementBalance_BalanceManagement(incrementBalance_actionCommonInfo_appInfo_appId,incrementBalance_actionCommonInfo_appInfo_reference,incrementBalance_actionCommonInfo_appInfo_extension_anyAttributeParam,incrementBalance_actionCommonInfo_appInfo_extension_any,incrementBalance_actionCommonInfo_userCode,incrementBalance_actionCommonInfo_opCost,incrementBalance_actionCommonInfo_opCost_exponent,incrementBalance_actionCommonInfo_currencyCode,incrementBalance_actionCommonInfo_extension_anyAttributeParam,incrementBalance_actionCommonInfo_extension_any,incrementBalance_subscriberId_choice,incrementBalance_adjustmentAmount,incrementBalance_adjustmentAmount_exponent,incrementBalance_walletId,incrementBalance_extension_anyAttributeParam,incrementBalance_extension_any,http_authorization,headers,privateRequest){
	    	var lRequest = "";
			lRequest = BalanceManagement.AS_URL + '?' + "_service=" + BalanceManagement.service + Ptf_DIM + "_application=" + BalanceManagement.application + Ptf_DIM + "_operation=" + "incrementBalance"
						 + Ptf_DIM + "_mode=" + "JSON"
						 + Ptf_DIM + "request=" +  request + Ptf_DIM + "incrementBalance.actionCommonInfo.appInfo.appId=" + encodeURIComponent(incrementBalance_actionCommonInfo_appInfo_appId) + Ptf_DIM + "incrementBalance.actionCommonInfo.appInfo.reference=" + encodeURIComponent(incrementBalance_actionCommonInfo_appInfo_reference) + Ptf_DIM + "incrementBalance.subscriberId.choice=" + encodeURIComponent(incrementBalance_subscriberId_choice) + buildHeaders_BalanceManagement(headers) + Ptf_DIM + "private=" + encodeURIComponent(privateRequest);
...
if(incrementBalance_actionCommonInfo_userCode != null){
lRequest = lRequest + Ptf_DIM + "incrementBalance.actionCommonInfo.userCode="+encodeURIComponent(incrementBalance_actionCommonInfo_userCode);
}
...
if(incrementBalance_walletId != null){
lRequest = lRequest + Ptf_DIM + "incrementBalance.walletId="+encodeURIComponent(incrementBalance_walletId);
}
...
lRequest = lRequest + Ptf_DIM + "http.authorization="+encodeURIComponent(base64Encode(http_authorization));
		...
		function queryBalanceAdjustment_BalanceManagement(queryBalanceAdjustment_queryCommonInfo_currencyCode,queryBalanceAdjustment_queryCommonInfo_pagingInfo_token,queryBalanceAdjustment_queryCommonInfo_pagingInfo_numRegs,queryBalanceAdjustment_queryCommonInfo_pagingInfo_extension_anyAttributeParam,queryBalanceAdjustment_queryCommonInfo_pagingInfo_extension_any,queryBalanceAdjustment_queryCommonInfo_extension_anyAttributeParam,queryBalanceAdjustment_queryCommonInfo_extension_any,queryBalanceAdjustment_subscriberId_choice,queryBalanceAdjustment_opReference_opId,queryBalanceAdjustment_opReference_opSubIdList_opId,queryBalanceAdjustment_opReference_opSubIdList_extension_anyAttributeParam,queryBalanceAdjustment_opReference_opSubIdList_extension_any,queryBalanceAdjustment_opReference_extension_anyAttributeParam,queryBalanceAdjustment_opReference_extension_any,queryBalanceAdjustment_fixingReferenceCode,queryBalanceAdjustment_timeInterval_startTime_choice,queryBalanceAdjustment_timeInterval_endTime_choice,queryBalanceAdjustment_timeInterval_extension_anyAttributeParam,queryBalanceAdjustment_timeInterval_extension_any,queryBalanceAdjustment_extension_anyAttributeParam,queryBalanceAdjustment_extension_any,http_authorization,headers,privateRequest){
	    	var lRequest = "";
			lRequest = BalanceManagement.AS_URL + '?' + "_service=" + BalanceManagement.service + Ptf_DIM + "_application=" + BalanceManagement.application + Ptf_DIM + "_operation=" + "queryBalanceAdjustment"
						 + Ptf_DIM + "_mode=" + "JSON"
						 + Ptf_DIM + "request=" +  request + Ptf_DIM + "queryBalanceAdjustment.subscriberId.choice=" + encodeURIComponent(queryBalanceAdjustment_subscriberId_choice) + buildHeaders_BalanceManagement(headers) + Ptf_DIM + "private=" + encodeURIComponent(privateRequest);
...
if(queryBalanceAdjustment_opReference_opId != null){
lRequest = lRequest + Ptf_DIM + "queryBalanceAdjustment.opReference.opId="+encodeURIComponent(queryBalanceAdjustment_opReference_opId);
}
if(queryBalanceAdjustment_opReference_opSubIdList_opId != null){
lRequest = lRequest + Ptf_DIM + "queryBalanceAdjustment.opReference.opSubIdList.opId="+encodeURIComponent(queryBalanceAdjustment_opReference_opSubIdList_opId);
}
...
if(queryBalanceAdjustment_timeInterval_startTime_choice != null){
lRequest = lRequest + Ptf_DIM + "queryBalanceAdjustment.timeInterval.startTime.choice="+encodeURIComponent(queryBalanceAdjustment_timeInterval_startTime_choice);
}
if(queryBalanceAdjustment_timeInterval_endTime_choice != null){
lRequest = lRequest + Ptf_DIM + "queryBalanceAdjustment.timeInterval.endTime.choice="+encodeURIComponent(queryBalanceAdjustment_timeInterval_endTime_choice);
}
...
lRequest = lRequest + Ptf_DIM + "http.authorization="+encodeURIComponent(base64Encode(http_authorization));
		...
		function queryBalances_BalanceManagement(queryBalances_queryCommonInfo_currencyCode,queryBalances_queryCommonInfo_pagingInfo_token,queryBalances_queryCommonInfo_pagingInfo_numRegs,queryBalances_queryCommonInfo_pagingInfo_extension_anyAttributeParam,queryBalances_queryCommonInfo_pagingInfo_extension_any,queryBalances_queryCommonInfo_extension_anyAttributeParam,queryBalances_queryCommonInfo_extension_any,queryBalances_subscriberId_choice,queryBalances_extension_anyAttributeParam,queryBalances_extension_any,http_authorization,headers,privateRequest){
	    	var lRequest = "";
			lRequest = BalanceManagement.AS_URL + '?' + "_service=" + BalanceManagement.service + Ptf_DIM + "_application=" + BalanceManagement.application + Ptf_DIM + "_operation=" + "queryBalances"
						 + Ptf_DIM + "_mode=" + "JSON"
						 + Ptf_DIM + "request=" +  request + Ptf_DIM + "queryBalances.subscriberId.choice=" + encodeURIComponent(queryBalances_subscriberId_choice) + buildHeaders_BalanceManagement(headers) + Ptf_DIM + "private=" + encodeURIComponent(privateRequest);
...
lRequest = lRequest + Ptf_DIM + "http.authorization="+encodeURIComponent(base64Encode(http_authorization));
		...
		function queryBalanceTransferBasics_BalanceManagement(queryBalanceTransferBasics_queryCommonInfo_currencyCode,queryBalanceTransferBasics_queryCommonInfo_pagingInfo_token,queryBalanceTransferBasics_queryCommonInfo_pagingInfo_numRegs,queryBalanceTransferBasics_queryCommonInfo_pagingInfo_extension_anyAttributeParam,queryBalanceTransferBasics_queryCommonInfo_pagingInfo_extension_any,queryBalanceTransferBasics_queryCommonInfo_extension_anyAttributeParam,queryBalanceTransferBasics_queryCommonInfo_extension_any,queryBalanceTransferBasics_opReference_opId,queryBalanceTransferBasics_opReference_opSubIdList_opId,queryBalanceTransferBasics_opReference_opSubIdList_extension_anyAttributeParam,queryBalanceTransferBasics_opReference_opSubIdList_extension_any,queryBalanceTransferBasics_opReference_extension_anyAttributeParam,queryBalanceTransferBasics_opReference_extension_any,queryBalanceTransferBasics_extension_anyAttributeParam,queryBalanceTransferBasics_extension_any,http_authorization,headers,privateRequest){
	    	var lRequest = "";
			lRequest = BalanceManagement.AS_URL + '?' + "_service=" + BalanceManagement.service + Ptf_DIM + "_application=" + BalanceManagement.application + Ptf_DIM + "_operation=" + "queryBalanceTransferBasics"
						 + Ptf_DIM + "_mode=" + "JSON"
						 + Ptf_DIM + "request=" +  request + buildHeaders_BalanceManagement(headers) + Ptf_DIM + "private=" + encodeURIComponent(privateRequest);
...
if(queryBalanceTransferBasics_opReference_opId != null){
lRequest = lRequest + Ptf_DIM + "queryBalanceTransferBasics.opReference.opId="+encodeURIComponent(queryBalanceTransferBasics_opReference_opId);
}
if(queryBalanceTransferBasics_opReference_opSubIdList_opId != null){
lRequest = lRequest + Ptf_DIM + "queryBalanceTransferBasics.opReference.opSubIdList.opId="+encodeURIComponent(queryBalanceTransferBasics_opReference_opSubIdList_opId);
}
...
lRequest = lRequest + Ptf_DIM + "http.authorization="+encodeURIComponent(base64Encode(http_authorization));
		...
		function queryTopUpsDetails_BalanceManagement(queryTopUpsDetails_queryCommonInfo_currencyCode,queryTopUpsDetails_queryCommonInfo_pagingInfo_token,queryTopUpsDetails_queryCommonInfo_pagingInfo_numRegs,queryTopUpsDetails_queryCommonInfo_pagingInfo_extension_anyAttributeParam,queryTopUpsDetails_queryCommonInfo_pagingInfo_extension_any,queryTopUpsDetails_queryCommonInfo_extension_anyAttributeParam,queryTopUpsDetails_queryCommonInfo_extension_any,queryTopUpsDetails_subscriberId_choice,queryTopUpsDetails_timeInterval_startTime_choice,queryTopUpsDetails_timeInterval_endTime_choice,queryTopUpsDetails_timeInterval_extension_anyAttributeParam,queryTopUpsDetails_timeInterval_extension_any,queryTopUpsDetails_topUpReferenceCode,queryTopUpsDetails_opStatus,queryTopUpsDetails_topUpOrigin,queryTopUpsDetails_extension_anyAttributeParam,queryTopUpsDetails_extension_any,http_authorization,headers,privateRequest){
	    	var lRequest = "";
			lRequest = BalanceManagement.AS_URL + '?' + "_service=" + BalanceManagement.service + Ptf_DIM + "_application=" + BalanceManagement.application + Ptf_DIM + "_operation=" + "queryTopUpsDetails"
						 + Ptf_DIM + "_mode=" + "JSON"
						 + Ptf_DIM + "request=" +  request + Ptf_DIM + "queryTopUpsDetails.subscriberId.choice=" + encodeURIComponent(queryTopUpsDetails_subscriberId_choice) + buildHeaders_BalanceManagement(headers) + Ptf_DIM + "private=" + encodeURIComponent(privateRequest);
...
if(queryTopUpsDetails_timeInterval_startTime_choice != null){
lRequest = lRequest + Ptf_DIM + "queryTopUpsDetails.timeInterval.startTime.choice="+encodeURIComponent(queryTopUpsDetails_timeInterval_startTime_choice);
}
if(queryTopUpsDetails_timeInterval_endTime_choice != null){
lRequest = lRequest + Ptf_DIM + "queryTopUpsDetails.timeInterval.endTime.choice="+encodeURIComponent(queryTopUpsDetails_timeInterval_endTime_choice);
}
...
lRequest = lRequest + Ptf_DIM + "http.authorization="+encodeURIComponent(base64Encode(http_authorization));
		...
		function queryTotalBalance_BalanceManagement(queryTotalBalance_queryCommonInfo_currencyCode,queryTotalBalance_queryCommonInfo_pagingInfo_token,queryTotalBalance_queryCommonInfo_pagingInfo_numRegs,queryTotalBalance_queryCommonInfo_pagingInfo_extension_anyAttributeParam,queryTotalBalance_queryCommonInfo_pagingInfo_extension_any,queryTotalBalance_queryCommonInfo_extension_anyAttributeParam,queryTotalBalance_queryCommonInfo_extension_any,queryTotalBalance_subscriberId_choice,queryTotalBalance_extension_anyAttributeParam,queryTotalBalance_extension_any,http_authorization,headers,privateRequest){
	    	var lRequest = "";
			lRequest = BalanceManagement.AS_URL + '?' + "_service=" + BalanceManagement.service + Ptf_DIM + "_application=" + BalanceManagement.application + Ptf_DIM + "_operation=" + "queryTotalBalance"
						 + Ptf_DIM + "_mode=" + "JSON"
						 + Ptf_DIM + "request=" +  request + Ptf_DIM + "queryTotalBalance.subscriberId.choice=" + encodeURIComponent(queryTotalBalance_subscriberId_choice) + buildHeaders_BalanceManagement(headers) + Ptf_DIM + "private=" + encodeURIComponent(privateRequest);
...
lRequest = lRequest + Ptf_DIM + "http.authorization="+encodeURIComponent(base64Encode(http_authorization));
		...
		function topUpAccount_BalanceManagement(topUpAccount_actionCommonInfo_appInfo_appId,topUpAccount_actionCommonInfo_appInfo_reference,topUpAccount_actionCommonInfo_appInfo_extension_anyAttributeParam,topUpAccount_actionCommonInfo_appInfo_extension_any,topUpAccount_actionCommonInfo_userCode,topUpAccount_actionCommonInfo_opCost,topUpAccount_actionCommonInfo_opCost_exponent,topUpAccount_actionCommonInfo_currencyCode,topUpAccount_actionCommonInfo_extension_anyAttributeParam,topUpAccount_actionCommonInfo_extension_any,topUpAccount_subscriberId_choice,topUpAccount_topUpAmount,topUpAccount_topUpAmount_exponent,topUpAccount_topUpOrigin,topUpAccount_validityPeriod,topUpAccount_SOSTopUpInfo_noPenaltyPeriod,topUpAccount_SOSTopUpInfo_balancePenaltyAmount,topUpAccount_SOSTopUpInfo_balancePenaltyAmount_exponent,topUpAccount_SOSTopUpInfo_extension_anyAttributeParam,topUpAccount_SOSTopUpInfo_extension_any,topUpAccount_completeTransact,topUpAccount_extension_anyAttributeParam,topUpAccount_extension_any,http_authorization,headers,privateRequest){
	    	var lRequest = "";
...
if(topUpAccount_actionCommonInfo_userCode != null){
lRequest = lRequest + Ptf_DIM + "topUpAccount.actionCommonInfo.userCode="+encodeURIComponent(topUpAccount_actionCommonInfo_userCode);
}
...
if(topUpAccount_topUpOrigin != null){
lRequest = lRequest + Ptf_DIM + "topUpAccount.topUpOrigin="+encodeURIComponent(topUpAccount_topUpOrigin);
}
if(topUpAccount_validityPeriod != null){
lRequest = lRequest + Ptf_DIM + "topUpAccount.validityPeriod="+encodeURIComponent(topUpAccount_validityPeriod);
}
if(topUpAccount_SOSTopUpInfo_noPenaltyPeriod != null){
lRequest = lRequest + Ptf_DIM + "topUpAccount.SOSTopUpInfo.noPenaltyPeriod="+encodeURIComponent(topUpAccount_SOSTopUpInfo_noPenaltyPeriod);
}
...
lRequest = lRequest + Ptf_DIM + "http.authorization="+encodeURIComponent(base64Encode(http_authorization));
		...
		function chargeAccount_BalanceManagement(chargeAccount_actionCommonInfo_appInfo_appId,chargeAccount_actionCommonInfo_appInfo_reference,chargeAccount_actionCommonInfo_appInfo_extension_anyAttributeParam,chargeAccount_actionCommonInfo_appInfo_extension_any,chargeAccount_actionCommonInfo_userCode,chargeAccount_actionCommonInfo_opCost,chargeAccount_actionCommonInfo_opCost_exponent,chargeAccount_actionCommonInfo_currencyCode,chargeAccount_actionCommonInfo_extension_anyAttributeParam,chargeAccount_actionCommonInfo_extension_any,chargeAccount_subscriberId_choice,chargeAccount_totalFlag,chargeAccount_chargingModality,chargeAccount_actionCauseCode,chargeAccount_extension_anyAttributeParam,chargeAccount_extension_any,http_authorization,headers,privateRequest){
	    	var lRequest = "";
			lRequest = BalanceManagement.AS_URL + '?' + "_service=" + BalanceManagement.service + Ptf_DIM + "_application=" + BalanceManagement.application + Ptf_DIM + "_operation=" + "chargeAccount"
						 + Ptf_DIM + "_mode=" + "JSON"
						 + Ptf_DIM + "request=" +  request + Ptf_DIM + "chargeAccount.actionCommonInfo.appInfo.appId=" + encodeURIComponent(chargeAccount_actionCommonInfo_appInfo_appId) + Ptf_DIM + "chargeAccount.actionCommonInfo.appInfo.reference=" + encodeURIComponent(chargeAccount_actionCommonInfo_appInfo_reference) + Ptf_DIM + "chargeAccount.subscriberId.choice=" + encodeURIComponent(chargeAccount_subscriberId_choice) + Ptf_DIM + "chargeAccount.totalFlag=" + encodeURIComponent(chargeAccount_totalFlag) + buildHeaders_BalanceManagement(headers) + Ptf_DIM + "private=" + encodeURIComponent(privateRequest);
...
if(chargeAccount_actionCommonInfo_userCode != null){
lRequest = lRequest + Ptf_DIM + "chargeAccount.actionCommonInfo.userCode="+encodeURIComponent(chargeAccount_actionCommonInfo_userCode);
}
