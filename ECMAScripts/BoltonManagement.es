...
function unsubscribeBolton_BoltonManagement(unsubscribeBolton_actionCommonInfo_appInfo_appId,unsubscribeBolton_actionCommonInfo_appInfo_reference,unsubscribeBolton_actionCommonInfo_appInfo_extension_any,unsubscribeBolton_actionCommonInfo_appInfo_extension_anyAttributeParam,unsubscribeBolton_actionCommonInfo_userCode,unsubscribeBolton_actionCommonInfo_opCost,unsubscribeBolton_actionCommonInfo_opCost_exponent,unsubscribeBolton_actionCommonInfo_currencyCode,unsubscribeBolton_actionCommonInfo_extension_any,unsubscribeBolton_actionCommonInfo_extension_anyAttributeParam,unsubscribeBolton_subscriberId_choice,unsubscribeBolton_boltonIdentifier_boltonCode,unsubscribeBolton_boltonIdentifier_boltonTypeCode,unsubscribeBolton_boltonIdentifier_boltonInstance,unsubscribeBolton_boltonIdentifier_extension_any,unsubscribeBolton_boltonIdentifier_extension_anyAttributeParam,unsubscribeBolton_extension_any,unsubscribeBolton_extension_anyAttributeParam,http_authorization,headers,privateRequest){
			var lRequest = "";
...
function queryBoltonsDetails_BoltonManagement(queryBoltonsDetails_queryCommonInfo_currencyCode,queryBoltonsDetails_queryCommonInfo_pagingInfo_token,queryBoltonsDetails_queryCommonInfo_pagingInfo_numRegs,queryBoltonsDetails_queryCommonInfo_pagingInfo_extension_any,queryBoltonsDetails_queryCommonInfo_pagingInfo_extension_anyAttributeParam,queryBoltonsDetails_queryCommonInfo_extension_any,queryBoltonsDetails_queryCommonInfo_extension_anyAttributeParam,queryBoltonsDetails_subscriberId_choice,queryBoltonsDetails_timeIntervalFilter_startTime_choice,queryBoltonsDetails_timeIntervalFilter_endTime_choice,queryBoltonsDetails_timeIntervalFilter_extension_any,queryBoltonsDetails_timeIntervalFilter_extension_anyAttributeParam,queryBoltonsDetails_boltonIdentifierFilter_boltonCode,queryBoltonsDetails_boltonIdentifierFilter_boltonTypeCode,queryBoltonsDetails_boltonIdentifierFilter_boltonInstance,queryBoltonsDetails_boltonIdentifierFilter_extension_any,queryBoltonsDetails_boltonIdentifierFilter_extension_anyAttributeParam,queryBoltonsDetails_extension_any,queryBoltonsDetails_extension_anyAttributeParam,http_authorization,headers,privateRequest){
			var lRequest = "";
			lRequest = BoltonManagement.AS_URL + '?' + "_service=" + BoltonManagement.service + Ptf_DIM + "_application=" + BoltonManagement.application + Ptf_DIM + "_operation=" + "queryBoltonsDetails"
						 + Ptf_DIM + "_mode=" + "JSON"
						 + Ptf_DIM + "request=" + request + Ptf_DIM + "queryBoltonsDetails.subscriberId.choice=" + encodeURIComponent(queryBoltonsDetails_subscriberId_choice) + Ptf_DIM + "queryBoltonsDetails.timeIntervalFilter.startTime.choice=" + encodeURIComponent(queryBoltonsDetails_timeIntervalFilter_startTime_choice) + Ptf_DIM + "queryBoltonsDetails.timeIntervalFilter.endTime.choice=" + encodeURIComponent(queryBoltonsDetails_timeIntervalFilter_endTime_choice) + buildHeaders_BoltonManagement(headers);
...
function subscribeBolton_BoltonManagement(subscribeBolton_actionCommonInfo_appInfo_appId,subscribeBolton_actionCommonInfo_appInfo_reference,subscribeBolton_actionCommonInfo_appInfo_extension_any,subscribeBolton_actionCommonInfo_appInfo_extension_anyAttributeParam,subscribeBolton_actionCommonInfo_userCode,subscribeBolton_actionCommonInfo_opCost,subscribeBolton_actionCommonInfo_opCost_exponent,subscribeBolton_actionCommonInfo_currencyCode,subscribeBolton_actionCommonInfo_extension_any,subscribeBolton_actionCommonInfo_extension_anyAttributeParam,subscribeBolton_subscriberId_choice,subscribeBolton_boltonInfo_boltonIdentifier_boltonCode,subscribeBolton_boltonInfo_boltonIdentifier_boltonTypeCode,subscribeBolton_boltonInfo_boltonIdentifier_boltonInstance,subscribeBolton_boltonInfo_boltonIdentifier_extension_any,subscribeBolton_boltonInfo_boltonIdentifier_extension_anyAttributeParam,subscribeBolton_boltonInfo_boltonAmount,subscribeBolton_boltonInfo_boltonAmount_exponent,subscribeBolton_boltonInfo_boltonLD,subscribeBolton_boltonInfo_boltonLD_exponent,subscribeBolton_boltonInfo_boltonMaxNumberOfSessions,subscribeBolton_boltonInfo_boltonCost,subscribeBolton_boltonInfo_boltonCost_exponent,subscribeBolton_boltonInfo_chargingModality,subscribeBolton_boltonInfo_timeInterval_startTime_choice,subscribeBolton_boltonInfo_timeInterval_endTime_choice,subscribeBolton_boltonInfo_timeInterval_extension_any,subscribeBolton_boltonInfo_timeInterval_extension_anyAttributeParam,subscribeBolton_boltonInfo_maxUnitsPerSession,subscribeBolton_boltonInfo_maxUnitsPerSession_exponent,subscribeBolton_boltonInfo_extension_any,subscribeBolton_boltonInfo_extension_anyAttributeParam,subscribeBolton_extension_any,subscribeBolton_extension_anyAttributeParam,http_authorization,headers,privateRequest){
			var lRequest = "";
			lRequest = BoltonManagement.AS_URL + '?' + "_service=" + BoltonManagement.service + Ptf_DIM + "_application=" + BoltonManagement.application + Ptf_DIM + "_operation=" + "subscribeBolton"
						 + Ptf_DIM + "_mode=" + "JSON"
						 + Ptf_DIM + "request=" + request + Ptf_DIM + "subscribeBolton.subscriberId.choice=" + encodeURIComponent(subscribeBolton_subscriberId_choice) + Ptf_DIM + "subscribeBolton.boltonInfo.timeInterval.startTime.choice=" + encodeURIComponent(subscribeBolton_boltonInfo_timeInterval_startTime_choice) + Ptf_DIM + "subscribeBolton.boltonInfo.timeInterval.endTime.choice=" + encodeURIComponent(subscribeBolton_boltonInfo_timeInterval_endTime_choice) + Ptf_DIM + "subscribeBolton.actionCommonInfo.appInfo.appId=" + encodeURIComponent(subscribeBolton_actionCommonInfo_appInfo_appId) + Ptf_DIM + "subscribeBolton.actionCommonInfo.appInfo.reference=" + encodeURIComponent(subscribeBolton_actionCommonInfo_appInfo_reference) + Ptf_DIM + "subscribeBolton.actionCommonInfo.userCode=" + encodeURIComponent(subscribeBolton_actionCommonInfo_userCode) + buildHeaders_BoltonManagement(headers);
...
function queryBoltons_BoltonManagement(queryBoltons_queryCommonInfo_currencyCode,queryBoltons_queryCommonInfo_pagingInfo_token,queryBoltons_queryCommonInfo_pagingInfo_numRegs,queryBoltons_queryCommonInfo_pagingInfo_extension_any,queryBoltons_queryCommonInfo_pagingInfo_extension_anyAttributeParam,queryBoltons_queryCommonInfo_extension_any,queryBoltons_queryCommonInfo_extension_anyAttributeParam,queryBoltons_subscriberId_choice,queryBoltons_boltonIdentifierFilter_boltonCode,queryBoltons_boltonIdentifierFilter_boltonTypeCode,queryBoltons_boltonIdentifierFilter_boltonInstance,queryBoltons_boltonIdentifierFilter_extension_any,queryBoltons_boltonIdentifierFilter_extension_anyAttributeParam,queryBoltons_boltonStatusFilter,queryBoltons_extension_any,queryBoltons_extension_anyAttributeParam,http_authorization,headers,privateRequest){
			var lRequest = "";
			lRequest = BoltonManagement.AS_URL + '?' + "_service=" + BoltonManagement.service + Ptf_DIM + "_application=" + BoltonManagement.application + Ptf_DIM + "_operation=" + "queryBoltons"
						 + Ptf_DIM + "_mode=" + "JSON"
						 + Ptf_DIM + "request=" + request + Ptf_DIM + "queryBoltons.subscriberId.choice=" + encodeURIComponent(queryBoltons_subscriberId_choice) + Ptf_DIM + "queryBoltons.boltonStatusFilter=" + encodeURIComponent(queryBoltons_boltonStatusFilter) + buildHeaders_BoltonManagement(headers);
