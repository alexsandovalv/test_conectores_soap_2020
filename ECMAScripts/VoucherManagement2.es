	...
	function voucherCardAccount_VoucherManagement(voucherCardAccount_actionCommonInfo_appInfo_appId,voucherCardAccount_actionCommonInfo_appInfo_reference,voucherCardAccount_actionCommonInfo_appInfo_extension_anyAttributeParam,voucherCardAccount_actionCommonInfo_appInfo_extension_any,voucherCardAccount_actionCommonInfo_userCode,voucherCardAccount_actionCommonInfo_opCost_exponent,voucherCardAccount_actionCommonInfo_extension_anyAttributeParam,voucherCardAccount_actionCommonInfo_extension_any,voucherCardAccount_subscriberId_choice,voucherCardAccount_topUpKey,voucherCardAccount_extension_anyAttributeParam,voucherCardAccount_extension_any,http_authorization,headers,privateRequest){
	    	var lRequest = "";
			lRequest = VoucherManagement.AS_URL + '?' + "_service=" + VoucherManagement.service + Ptf_DIM + "_application=" + VoucherManagement.application + Ptf_DIM + "_operation=" + "voucherCardAccount"
						 + Ptf_DIM + "_mode=" + "JSON"
						 + Ptf_DIM + "request=" +  request + Ptf_DIM + "voucherCardAccount.actionCommonInfo.appInfo.appId=" + encodeURIComponent(voucherCardAccount_actionCommonInfo_appInfo_appId) + Ptf_DIM + "voucherCardAccount.actionCommonInfo.appInfo.reference=" + encodeURIComponent(voucherCardAccount_actionCommonInfo_appInfo_reference) + Ptf_DIM + "voucherCardAccount.subscriberId.choice=" + encodeURIComponent(voucherCardAccount_subscriberId_choice) + Ptf_DIM + "voucherCardAccount.topUpKey=" + encodeURIComponent(voucherCardAccount_topUpKey) + buildHeaders_VoucherManagement(headers) + Ptf_DIM + "private=" + encodeURIComponent(privateRequest);
...
if(voucherCardAccount_actionCommonInfo_userCode != null){
lRequest = lRequest + Ptf_DIM + "voucherCardAccount.actionCommonInfo.userCode="+encodeURIComponent(voucherCardAccount_actionCommonInfo_userCode);
}
